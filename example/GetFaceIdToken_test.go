...
import (
	"encoding/json"
	"github.com/tencentcloud/faceid-api-crypto-golang"
...
func TestGetFaceIdToken(t *testing.T) {
	...
	request := tencentcloudsdk.NewGetFaceIdTokenRequest()
	...
	request.CompareLib = common.StringPtr("BUSINESS")

	// Step 4. 调用接口
	response, err := client.GetFaceIdToken(request)
	if err != nil {
